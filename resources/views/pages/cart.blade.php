              ...
              <tbody>
                <tr>
                  ...
                  <td style="width: 35%;">
                    ...
                    <div class="product-subtitle">by Dtech</div>
                  </td>
                  <td style="width: 35%;">
                    <div class="product-title">Rp. 1015709</div>
                    <div class="product-subtitle">IDR</div>
                  </td>
                  <td style="width: 20%;">
                    <a href="#" class="btn btn-secondary btn-remove-cart">
                      Remove
                    </a>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="width: 35%;">
                    <div class="product-title">Rp. 6478481</div>
                    <div class="product-subtitle">IDR</div>
                  </td>
                  <td style="width: 20%;">
                    <a href="#" class="btn btn-secondary btn-remove-cart">
